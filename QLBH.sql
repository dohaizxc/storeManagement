...
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Nguyễn Văn Thành', 'Nam','0952116854',12200,1220000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Trần Ngọc Hân','Nữ','0554662358',18200,1820000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Tran Ngoc Linh','Nữ','0781054669',13920,1392000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Trần Minh Long','Nam','0500474447',5900,590000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Lê Nhật Minh','Nam','0546854225',5100,510000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Lê Hoài Thương','Nữ','0457456589',3640,364000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Nguyễn Văn Tâm','Nam','0456158256',5240,524000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Phan Thị Thanh','Nữ','0568004056',4380,438000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Lê Hà Vinh','Nam','0451258156',5820,582000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Hà Duy Lập','Nam','0458147145',8880,888000.00);
insert into KHACHHANG (HOTEN, GIOITINH,SODT,TICHDIEM,TONGCHITIEU) values('Nam Lập','Nam','0458144345',8880,888000.00);
...
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2022-01-10','KH01','NV01','66000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2022-02-10','KH02','NV02','476000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2022-03-10','KH03','NV03','372000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2022-04-10','KH04','NV04','295000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2022-05-10','KH05','NV05','255000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2022-06-10','KH06','NV01','182000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2021-01-10','KH07','NV02','324000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2021-02-10','KH08','NV03','200000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2021-03-10','KH09','NV04','238000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2021-4-10','KH10','NV05','344000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2021-5-10','KH01','NV01','544000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2021-6-10','KH02','NV02','544000.00');
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2021-7-10','KH03','NV03','324000.00');
...
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-01-10','KH01','NV01',66000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-02-10','KH02','NV02',476000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-03-10','KH03','NV03',372000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-04-10','KH04','NV04',295000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-05-10','KH05','NV05',255000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-06-10','KH06','NV01',182000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-01-10','KH07','NV02',200000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-02-10','KH08','NV03',238000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-03-10','KH09','NV04',344000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-4-10','KH10','NV05',544000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-5-10','KH01','NV01',544000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-6-10','KH02','NV02',324000.00);
insert into HOADON (NGAYLAP,MAKH,MANV,TONGTIEN) values('2020-7-10','KH03','NV03',324000.00);
